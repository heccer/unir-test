...
@api_application.route("/calc/squareroot/<op_1>/<op_2>", methods=["GET"])
def squareroot_2(op_1, op_2):
    try:
        return ("squareroot method only requires one parameter /calc/squareroot/PARAMETER", http.client.BAD_REQUEST, HEADERS)
    except TypeError as e:
        return (str(e), http.client.BAD_REQUEST, HEADERS)
...
def log10_2(op_1, op_2):
    try:
        return ("log10 method only requires one parameter /calc/log10/PARAMETER", http.client.BAD_REQUEST, HEADERS)
    except TypeError as e:
        return (str(e), http.client.BAD_REQUEST, HEADERS)
